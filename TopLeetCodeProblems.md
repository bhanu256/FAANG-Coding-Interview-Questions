...
## Interval (can increase time complexity at cost of space)
...
- [x] [Add and Search Word (can do better)](https://leetcode.com/problems/add-and-search-word-data-structure-design/)
...
- [x] [Coin Change (can improve performance seriously)](https://leetcode.com/problems/coin-change/)
...
- [x] [Merge K Sorted Lists (done using merge sort)](https://leetcode.com/problems/merge-k-sorted-lists/)
- [x] [Top K Frequent Elements (can do better)](https://leetcode.com/problems/top-k-frequent-elements/)
